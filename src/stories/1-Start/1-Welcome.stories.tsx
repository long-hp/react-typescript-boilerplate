...
export const Start = () => {
  return (
    <View>
      ...
      <Space size={10} />
      <Image src="https://wiloke-images.netlify.app/wiloke-react-core/1.png" />
      ...
      <Space size={10} />
      <Image src="https://wiloke-images.netlify.app/wiloke-react-core/2.png" />
      ...
      <Space size={10} />
      <Image src="https://wiloke-images.netlify.app/wiloke-react-core/3.png" />

      <Space size={20} />
      <Text tagName="h3">
        {`4. Kiến trúc và shared các thành phần để truy cập phía bên ngoài containers hoặc components. Ở hình dưới ta export { HomePage, reducerHomePage, sagaHomePage } để có thể import sử dụng cho router hay store.`}
      </Text>
      <Space size={10} />
      <Text>Lưu ý containers A không thể sử dụng các actions từ containers B</Text>
      <Space size={10} />
      <Image src="https://wiloke-images.netlify.app/wiloke-react-core/4.png" />

      <Space size={20} />
      <Text tagName="h3">
        5. Sử dụng Atomic CSS{' '}
      ...
      <Space size={20} />
      <Text tagName="h3">
        6. Giải thích qua về kiến trúc trong{' '}
