...
const RangeSlideBeautyLoading: FC<RangeSlideBeautyLoadingProps> = () => {
  return (
    <View tachyons={['relative', 'overflow-hidden']}>
      ...
      <View tachyons={['pv2', 'ph4', 'flex', 'items-center']} backgroundColor="gray5" radius={6}>
        <View height={6} tachyons={['flex-grow-1', 'relative']} radius={4} backgroundColor="gray4">
          <View
            width={23}
            height={23}
            radius={50}
        ...
        <View width={65} height={30} tachyons={['ml4']} backgroundColor="gray4" radius={4} />
      </View>
